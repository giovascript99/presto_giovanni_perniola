<x-layout>
    <div class="container-fluid min-vh-100 d-flex pt-5 justify-content-center tech-main-section">
        <div class="col-12 col-md-6 col-lg-4 py-5">
            ...
            <form class="tech-form-card p-4 rounded-4" action="{{ route('register') }}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group tech-input-group">
                        ...
                        <input type="text" name="name" class="form-control tech-input" placeholder="CyberUser_01"
                            value="{{ old('name') }}">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group tech-input-group">
                        ...
                        <input type="password" name="password" class="form-control tech-input" placeholder="••••••••">
                    </div>
                </div>
